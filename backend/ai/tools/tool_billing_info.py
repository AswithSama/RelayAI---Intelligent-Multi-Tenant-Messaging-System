...
def get_customer_account_info(
    ...
    if playground_context:
        return {
            "account_number": playground_context.get("account_number"),
            "customer_name": playground_context.get("customer_name"),
            "customer_phone": playground_context.get("customer_phone"),
            "crm": playground_context.get("crm"),
        }
